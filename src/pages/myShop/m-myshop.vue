  ...
  methods: {
    ...
    wxShare(inviterCode) {
      ...
      this.request("wisdom.vshop.wechatOpen.getJsconf", {
        url: window.location.origin + "/shoppage?storeCode="+inviterCode
      }).then(data => {
          ...
          wx.ready(function(){
            wx.updateAppMessageShareData({
              ...
              link: window.location.origin + "/shoppage?storeCode="+inviterCode, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
